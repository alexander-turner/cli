...
// Returns the list of issues found in a specific analysis run (identified by commit OID).
// commitOID : The commit SHA to look up the analysis run for
// limit : The amount of issues to be listed. The default limit is 30 while the maximum limit is currently 100.
func (c Client) GetIssuesForCommit(ctx context.Context, commitOID string, limit int) ([]issues.Issue, error) {
